...
import ApplyCv from '../detail/apply-cv';

const pages = ['Việc Làm IT', 'Công Ty IT', 'Blog IT'];
...
function ResponsiveHeader() {
  ...
  return (
    <AppBar
      position="static"
      sx={{ backgroundColor: 'var(--mui-palette-common-white)', color: 'var(--mui-palette-neutral-600)' }}
    >
        ...
        <Toolbar disableGutters>
          ...
          <Box
            sx={{
              ...
              '&:hover': {
                backgroundColor: '#ed4c4f',
                boxShadow: ' 0px 4px 14px #C50E1B',
              },
            }}
          >
            <Button
          ...
          <ApplyCv open={applyDialogOpen} onClose={handleApplyDialogClose} />
        </Toolbar>
      </Container>
    </AppBar>
  );
