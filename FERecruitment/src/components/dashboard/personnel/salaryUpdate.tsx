...
export default function SalaryUpdate({ open, onClose }: SalaryUpdateProps): React.JSX.Element {
  ...
  return (
    <Dialog open={open} onClose={onClose} fullWidth maxWidth="sm" scroll={"body"}>
      <DialogTitle sx={{ p: 3 }}>Cập nhật lương</DialogTitle>
      <IconButton
        aria-label="close"
        onClick={onClose}
        sx={{
      ...
      <DialogContent dividers={"body"} sx={{ p: 2 }}>
